...
const billingPlans: BillingPlan[] = [
  {
    ...
    price: 29,
    interval: "monthly",
    features: ["Up to 1,000 products", "Basic reporting", "Email support", "2 team members"],
    current: false
  },
  {
    id: "professional",
    ...
    price: 79,
    interval: "monthly",
    features: ["Up to 10,000 products", "Advanced analytics", "Priority support", "10 team members", "API access"],
    current: true
  },
  {
    id: "enterprise",
    ...
    price: 199,
    interval: "monthly",
    features: ["Unlimited products", "Custom integrations", "Dedicated support", "Unlimited team members", "White-label options"],
    current: false
  }
]
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Manage your account, billing, and preferences</p>
          </div>
        </div>
      </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="companyName" defaultValue="Inventara Solutions" />
                </div>
                <div className="space-y-2">
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600">Upload data from a JSON file</p>
                  <Button variant="outline" className="w-full">
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">₹79/month</p>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {billingPlans.map((plan) => (
                  <Card key={plan.id} className={plan.current ? "ring-2 ring-blue-500" : ""}>
                    <CardHeader>
                ...
                {[1, 2, 3].map((i) => (
                  <div key={i} className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">December {i}, 2023</p>
                    </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600">Created: December 1, 2023</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Receive updates about purchase orders</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get weekly inventory summaries</p>
                  </div>
                  <Switch />
                </div>
                <div className="flex items-center justify-between">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Show live updates in the dashboard</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Play sounds for important alerts</p>
                  </div>
                  <Switch />
                </div>
                <div className="flex items-center justify-between">
